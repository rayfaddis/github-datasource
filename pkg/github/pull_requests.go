...
func (p PullRequests) Frames() data.Frames {
	...
	for _, v := range p {
		var (
			closedAt        *time.Time
			mergedAt        *time.Time
			mergedByName    *string = nil
			mergedByLogin   *string = nil
			mergedByEmail   *string = nil
			mergedByCompany *string = nil
